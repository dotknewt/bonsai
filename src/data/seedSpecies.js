...
export const SEED_SPECIES = [{
  ...
  id: "jade-crassula-ovata",
  name: "Jade",
  botanicalName: "Crassula ovata",
  // Care adapted from the Bonsai4me Crassula ovata guide (Harry Harrington), cross-checked against the RHS, Bonsai Empire and UK houseplant sources, shifted ~3-4 weeks for Norway. Frost-tender succulent — treat as an indoor tree; overwatering in cold conditions is the main killer.
  tasks: [
    { id: "co1", title: "Resume light watering as growth starts", startMonth: 4, startDay: 15, endMonth: 5, endDay: 15, category: "other", description: "Water a little more often as new growth appears, but only once the compost has dried out — wrinkled leaves mean it's thirsty, not a fixed schedule." },
    { id: "co2", title: "Repot in fast-draining mix (every 2–3 years)", startMonth: 5, startDay: 1, endMonth: 5, endDay: 25, category: "repot", description: "Use a fast-draining, gritty/inorganic mix — jade likes to be slightly under-potted, not root-bound. Don't water for about a week afterwards, so cut roots can dry and callous; watering too soon leads straight to root rot." },
    { id: "co3", title: "Start monthly balanced feed", startMonth: 5, startDay: 10, endMonth: 9, endDay: 1, category: "feed", description: "A balanced feed once a month from mid-spring to autumn is all it needs — strong light matters far more than fertiliser. Stop feeding once autumn sets in." },
    { id: "co4", title: "Structural pruning & trunk work", startMonth: 5, startDay: 15, endMonth: 6, endDay: 20, category: "prune", description: "Jade tolerates hard cuts and trunk chops well, budding from the wound within 1–2 weeks. Never seal cuts — sealant traps moisture against the wound and causes rot; leave it open to dry." },
    { id: "co5", title: "Move outdoors after the last frost", startMonth: 6, startDay: 10, endMonth: 6, endDay: 25, category: "other", description: "Once nights are reliably frost-free, move to a bright, sheltered spot outdoors — acclimate gradually over 1–2 weeks to avoid sunburn, and keep it out of prolonged rain." },
    { id: "co6", title: "Wiring — withhold water first", startMonth: 6, startDay: 15, endMonth: 7, endDay: 31, category: "wire", description: "Wire loosely on lignified branches and bend gradually — the soft bark marks easily and branches can snap. Don't water beforehand; turgid branches are far more likely to snap and mark. Branches set in 3–4 weeks — check weekly, as wire bites in fast." },
    { id: "co7", title: "Pinch new growth through summer", startMonth: 6, startDay: 1, endMonth: 9, endDay: 15, category: "prune", description: "Continually pinch new shoots back to 2–3 leaf pairs to build ramification and keep leaves small. Stop by mid-September so late growth has time to harden before coming back indoors." },
    { id: "co8", title: "Peak summer watering", startMonth: 6, startDay: 1, endMonth: 8, endDay: 31, category: "other", description: "Water most often now — roughly every 2–7 days in warm, bright conditions — but always check the compost is dry first. Wrinkled leaves mean underwatered; mushy or yellowing leaves mean overwatered." },
    { id: "co9", title: "Take cuttings", startMonth: 6, startDay: 1, endMonth: 8, endDay: 15, category: "propagate", description: "Stem or leaf cuttings root readily in sandy, well-drained compost — even a single leaf laid on the surface will strike. Let cut ends callous for a few days first for best results." },
    { id: "co10", title: "Bring indoors — inspect for pests first", startMonth: 8, startDay: 25, endMonth: 9, endDay: 15, category: "pest", description: "Bring it back indoors well before the weather turns, checking closely for mealybug, scale and spider mites before it comes inside — infestations are more likely in winter's warm, dry indoor air. Treat with isopropyl alcohol, insecticidal soap or neem. If overnight temperatures approach 5°C outdoors, bring it in immediately regardless of date." },
    { id: "co11", title: "Taper watering and stop feeding", startMonth: 9, startDay: 1, endMonth: 10, endDay: 15, category: "other", description: "Ease off watering and stop feeding as growth slows for the year — indoors, this is the point to switch to a bright, cool spot." },
    { id: "co12", title: "Winter rest — keep above 5–7°C, water sparingly", startMonth: 10, startDay: 15, endMonth: 4, endDay: 10, category: "other", description: "Never let it drop below about 5–7°C — this is a frost-tender succulent, not a hardy bonsai. Water as little as once every 2–3 weeks, only when leaves start to wrinkle; cold, wet roots are the main way jade dies over winter. A cool (10–15°C), bright, dry spell can trigger autumn/winter flowering, but treat that as a bonus, not a target." },
  ],
}];
